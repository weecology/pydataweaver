...
from pydataweaver.lib.scripts import SCRIPT_LIST as WEAVER_ALL_SCRIPTS
from pydataweaver.lib.tools import open_fw
from pydataweaver.lib.defaults import VERSION, COPYRIGHT
