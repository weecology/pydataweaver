...
setup(
    ...
    name='weaver',      #------------name of project and top folder 
    version=clean_version(VERSION),    #------------Use clean_version(v) later add versioning control
    ...
    keywords='Eco-data mining and knowledge representation',
